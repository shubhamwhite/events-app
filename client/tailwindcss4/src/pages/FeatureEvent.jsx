    ...
    const fetchEvents = async () => {
      try {
        const response = await fetch(
          "http://localhost:5000/api/v1/dashboard/feature-event/get"
        );
          ...
          setEvents([
            {
              ...
              description:
                "Join us for an evening of networking, fine dining, and entertainment at our annual corporate gala.",
              image:
            ...
            },
            {
              ...
              description:
                "Discover the latest trends in wedding planning and meet top vendors at our summer showcase event.",
              image:
            ...
            },
            {
              ...
              description:
                "Explore the future of technology with industry leaders and innovative startups at our annual tech conference.",
              image:
            ...
            },
            {
              ...
              description:
                "Experience culinary excellence with top chefs and sommeliers at our annual food and wine festival.",
              image:
            ...
            },
            {
              ...
              description:
                "Be among the first to view stunning contemporary artworks at our gallery opening night.",
              image:
                "https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
      ...
      >
        ...
        >
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
            Discover our upcoming signature events and join us for unforgettable
            experiences crafted with passion and attention to detail.
          </p>
        </motion.div>
